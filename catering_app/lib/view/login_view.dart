...
import 'package:catering_app/view/order_list_view.dart'; // Import OrderListView
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const CateringCompanyListView()),
                  );
                },
                child: const Text(
                  'Pokaż Firmy Cateringowe',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                ),
              ),
            ],
